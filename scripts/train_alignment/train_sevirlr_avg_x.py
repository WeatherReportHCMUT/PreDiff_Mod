...
from utils.path import default_pretrained_alignment_dir,pretrained_sevirlr_alignment_dir
...
def main():
    ...
    if args.pretrained:
        alignment_ckpt_path = os.path.join(default_pretrained_alignment_dir,pretrained_sevirlr_alignment_dir)
